...
module.exports = GbifTileSource;

function GbifTileSource(options) {
...
GbifTileSource.prototype = util.inherit(Evented, {
    minzoom: 0,
    maxzoom: 22,
    tileSize: 512,
    ...
    _loadTile: function(tile) {
        ...
        if (tile.workerID) {
            ...
            tile.workerID = this.dispatcher.send('load datacube tile', params, this._tileLoaded.bind(this, tile));
        }
    },
